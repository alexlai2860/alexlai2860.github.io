...
<div class="service-section fade-in">
    ...
    <div class="service-card">
        <div class="service-list">
            ...
            <p><strong>Generative Models.</strong> I believe research should matter to real users. My contributions include <strong>PosterCraft [ICLR'26]</strong> for high-quality aesthetic poster generation and <strong>PosterOmni [CVPR'26]</strong> for versatile poster editing, pushing the boundaries of visual content creation and achieving widespread community adoption.</p>
        </div>
    </div>
</div>
