...
<div class="content-wrapper">
    ...
    <style>
        ...
        .analysis-key-strength {
            color: #166534;
            font-weight: 700;
        }
        .analysis-key-contrast {
            color: #6d28d9;
            font-weight: 700;
        }
        .flow-arrow {
        ...
        .analysis-overlay-content .analysis-key-issue {
            color: #b91c1c;
            font-weight: 700;
        }
        .analysis-overlay-content .analysis-key-strength {
            color: #166534;
            font-weight: 700;
        }
        .analysis-overlay-content .analysis-key-contrast {
            color: #6d28d9;
            font-weight: 700;
        }
    ...
    <script>
        (function(){
            ...
            function applyKeywordHighlights(html) {
                ...
                var contrastPatterns = [
                    /significantly better/gi,
                    /in contrast/gi,
                    /whereas/gi,
                    /primarily due to/gi
                ];
                strengthPatterns.forEach(function(re) {
                    html = html.replace(re, function(m){ return '<span class="analysis-key-strength">' + m + '</span>'; });
                });
                issuePatterns.forEach(function(re) {
                    html = html.replace(re, function(m){ return '<span class="analysis-key-issue">' + m + '</span>'; });
                });
                contrastPatterns.forEach(function(re) {
                    html = html.replace(re, function(m){ return '<span class="analysis-key-contrast">' + m + '</span>'; });
                });
                return html;
            }
