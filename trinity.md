...
<main>
  ...
  <section class="section section-wide" id="showcase">
    <div class="section-head reveal">
      <div>
        <p class="eyebrow">Design Gallery</p>
        <h2 class="section-title">Generated outputs across devices, posters, and campaign formats.</h2>
      </div>
      <p class="section-copy">A small sample wall from the current Trinity design outputs. The page keeps the paper figures for methodology and evaluation, while this gallery gives visitors a direct sense of visual quality and format diversity. Click any design to view it full screen.</p>
    </div>
    <div class="showcase-wall reveal">
      <button class="showcase-card tall" type="button" data-lightbox-src="/images/trinity/showcase/showcase-01.jpg">
        <img src="/images/trinity/showcase/showcase-01.jpg" alt="Mobile mockup generated by Trinity">
      </button>
      <button class="showcase-card wide" type="button" data-lightbox-src="/images/trinity/showcase/showcase-06.jpg">
        <img src="/images/trinity/showcase/showcase-06.jpg" alt="Wide campaign banner generated by Trinity">
      </button>
      <button class="showcase-card large" type="button" data-lightbox-src="/images/trinity/showcase/showcase-03.jpg">
        <img src="/images/trinity/showcase/showcase-03.jpg" alt="Quartr poster generated by Trinity">
      </button>
      <button class="showcase-card tall" type="button" data-lightbox-src="/images/trinity/showcase/showcase-05.jpg">
        <img src="/images/trinity/showcase/showcase-05.jpg" alt="Xiaomi product poster generated by Trinity">
      </button>
      <button class="showcase-card wide" type="button" data-lightbox-src="/images/trinity/showcase/showcase-07.jpg">
        <img src="/images/trinity/showcase/showcase-07.jpg" alt="Wide public interest preview generated by Trinity">
      </button>
      <button class="showcase-card" type="button" data-lightbox-src="/images/trinity/showcase/showcase-04.jpg">
        <img src="/images/trinity/showcase/showcase-04.jpg" alt="Quartr visual page generated by Trinity">
      </button>
      <button class="showcase-card tall" type="button" data-lightbox-src="/images/trinity/showcase/showcase-02.jpg">
        <img src="/images/trinity/showcase/showcase-02.jpg" alt="Second mobile mockup generated by Trinity">
      </button>
      <button class="showcase-card wide" type="button" data-lightbox-src="/images/trinity/showcase/showcase-08.jpg">
        <img src="/images/trinity/showcase/showcase-08.jpg" alt="Wide design preview generated by Trinity">
      </button>
      <button class="showcase-card" type="button" data-lightbox-src="/images/trinity/showcase/showcase-09.jpg">
        <img src="/images/trinity/showcase/showcase-09.jpg" alt="Poster design generated by Trinity">
      </button>
      <button class="showcase-card" type="button" data-lightbox-src="/images/trinity/showcase/showcase-10.jpg">
        <img src="/images/trinity/showcase/showcase-10.jpg" alt="Campaign poster generated by Trinity">
      </button>
      <button class="showcase-card wide" type="button" data-lightbox-src="/images/trinity/showcase/showcase-11.jpg">
        <img src="/images/trinity/showcase/showcase-11.jpg" alt="Landscape poster generated by Trinity">
      </button>
      <button class="showcase-card" type="button" data-lightbox-src="/images/trinity/showcase/showcase-12.jpg">
        <img src="/images/trinity/showcase/showcase-12.jpg" alt="Additional poster generated by Trinity">
      </button>
    </div>
  </section>
